...
### 运行
```
python -m light_tts.server.api_server --data_type float16 --load_trt True --model_dir /data/www/ComfyUI/models/cosyvoice/Fun-CosyVoice3-0.5B/FunAudioLLM/Fun-CosyVoice3-0.5B-2512 --port 9705 --host 0.0.0.0                                  
```
