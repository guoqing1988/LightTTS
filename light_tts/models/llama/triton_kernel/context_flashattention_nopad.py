...
def _fwd_kernel_no_prompt_cache(
    ...
    # 比如Q是[n_tokens, head, head_dim]，那么这里的q就是从[BLOCK_M, 1, BLOCK_DMODEL]这样
    ...
    # 由于grid的第一个参数是cdiv(max_input_len, BLOCK_M)，所以这里的batch_seq_len有可能比block_start_loc小，那就不用算了
    ...
    for start_n in range(0, block_mask * block_end_loc, BLOCK_N):
        ...
        # -- compute qk ----
        # 以BLOCK_N个tokens为单位取出batch中这个req的所有kvcache
